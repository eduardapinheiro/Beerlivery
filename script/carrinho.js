                ...
                for(var count=1 ; count < itens.length ; count++){
                    ...
                    for(var count2=1 ; count2 < itens2.length ; count2++){
                        ...
                        if(itens2[count2].id == itens[count].id){
                            ...
                            precoTotal += parseFloat(itens2[count2].preco);

                            $("#preencherCarrinho").append('<tr class="productitm"><td id="itemCarrinho"><img src="img/bebidas/' + itens[count].id + '.png" class="thumb"></td><td id="qtdCarrinho"><input id="precoItem' + itens2[count2].id + '" type="number" value="' + itens[count].qtd + '" min="0" max="99" class="qtyinput"></td><td id="produtoCarrinho">' + itens2[count2].nome + '</td><td id="precoCarrinho">' + itens2[count2].preco + '</td><td><span class="remove"><img src="img/trash.png" alt="X"></span></td><td><button onclick="atualizarItem('+itens2[count2].id+')">Atualizar</button></td></tr>');
                        }
                    }
                }
